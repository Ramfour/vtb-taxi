...
>
    <section class="manager-grid">
        <article class="hero-banner" data-reveal>
            ...
            <p>Руководитель одновременно остаётся обычным сотрудником, поэтому может подавать собственные поездки и здесь же управлять всей очередью команды.</p>
            ...
            <div class="metric-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-note">Можно финализировать в основной слой.</div>
                </div>
            </div>
        </article>
            ...
            <section class="panel" data-reveal>
                <div class="panel-header">
                    <div>
                        ...
                        <p>Если нужно, можно ограничить перенос временным диапазоном.</p>
                    </div>
                </div>
        ...
        <article class="panel" data-reveal>
            <div class="panel-header">
                <div>
                    ...
                    <p>Именно отсюда начинается управляемый поток: решение, комментарий и дальнейшая финализация.</p>
                </div>
